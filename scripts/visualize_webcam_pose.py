...
from geekseek.perception import MediaPipePersonSensor
...
def main() -> None:
    ...
    # PersonSensor.sense() only returns the reduced signal, so re-run the
    # raw landmarker here to get full keypoints for drawing.
